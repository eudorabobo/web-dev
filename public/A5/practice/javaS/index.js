...
//ES6 template
const arrayTemplate = (array) => {
  let result = `(${array.length}) [${array.map(element => `${Array.isArray(element) ? 'Array(' + element.length + ')'
...
//     }
//   }
//   res += Array.isArray(array[len-1]) ? 'Array(' + array[len-1].length + ')' : typeof array[len-1] === 'string' ? '"' + array[len-1] + '"' : array[len-1];
//   res += ']';
//   console.log(res);
// }
console.log('Arrays');
// printArray(numberArray1);
console.log(arrayTemplate(numberArray1));
// printArray(stringArray1);
console.log(arrayTemplate(stringArray1));
// printArray(variableArray1)
console.log(arrayTemplate(variableArray1));
...
console.log(arrayTemplate(squares));
const cubes = numberArray1.map(a => a * a * a);
console.log(arrayTemplate(cubes));
...
console.log(arrayTemplate(numberArray1));
console.log(arrayTemplate(numbersGreaterThan2));
console.log(arrayTemplate(evenNumbers));
console.log(arrayTemplate(oddNumbers));
