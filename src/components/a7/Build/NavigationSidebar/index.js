  ...
  return (
      <>
        <div className="list-group">
          ...
          <Link to="/a7/twitter/home" className={`list-group-item ${active === 'home' ? 'active' : ''}`}><i
          ...
          <Link id="profile" to="/a7/twitter/profile" className={`list-group-item ${active === 'profile' ? 'active' : ''}`}><i
