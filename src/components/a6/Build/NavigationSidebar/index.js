...
import "../ExplroeScreen/explore.css"
  ...
  return (
      <>
        <div className="list-group">
          <Link to="/a6/"><i className="fab fa-twitter fa-2x"></i></Link>
          <Link to="/a6/twitter/home" className={`list-group-item ${active === 'home' ? 'active' : ''}`}><i
              className="fa fa-home"></i> Home</Link>
          <Link to="/a6/twitter/explore"
                className={`list-group-item ${active === 'home' ? 'active' : ''}`}><i
          ...
          <Link id="profile" to="#" className="list-group-item"><i
